...
## 4. [File operations](https://github.com/DataBaby20/Python-assignments/blob/master/file_operations.py):
...
## 5. [Lists](https://github.com/DataBaby20/Python-assignments/blob/master/lists.py):
